        ...
        >
          <div className="glass rounded-3xl p-5">
            <div className="flex items-center gap-4">
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-accent-blue/40 via-accent-purple/40 to-accent-cyan/40 text-xl font-semibold text-white">
                AE
              </div>
              <div>
