      ...
      <div className="max-width section-padding !py-12">
        <div className="flex flex-col items-start justify-between gap-8 md:flex-row md:items-center">
          <div className="flex items-center gap-3">
            <div className="relative flex h-10 w-10 items-center justify-center overflow-hidden rounded border border-stone-700 bg-stone-800">
          ...
          <nav className="flex flex-wrap gap-x-6 gap-y-2 text-sm text-stone-300">
            {socials.map((s) => (
              <a
                key={s.label}
                href={s.href}
        ...
        <div className="mt-8 flex flex-col gap-2 text-xs text-stone-500 md:flex-row md:items-center md:justify-between">
